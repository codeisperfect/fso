	...
	<div class="content-common">
		...
		<div class="disabled-fields">
			...
			<div class="inputBlock">
				...
				<input id="order_customer_mobile" name="order[customer_mobile]" placeholder="phone" type="text" validation_required="req, numeric, maxlength=11,minlength=10" value="" />
			...
			<div class="vehicle_details">
				...
				<div class="book-actions confirm-vehicle-section" style="text-align: center">
					<div class="clearfix" style="margin-bottom: 30px">
						<button type="button" id="book_myorder_now" class="btn btn-primary btn-lg" onclick='updatePreviewAndBook();' > Book Now</button>
					</div>
	...
	<div class="other_details content-common">
		...
		<div class="" style="display: inline-block;width: 640px;vertical-align: top">
			<div class='inputBlock' style="width: 620px;display: block">
				...
				<input id="company_name" name="company_name" placeholder="Company Name" style="width:250px;" type="text" value="" />
			</div>
...
<!-- 			<p style="text-align: center;margin-bottom: 20px;">
 ...
 -->
			<p style="text-align: center;margin-bottom: 20px;">
			<button onclick='getorderdata();this.disabled=true;' type='button' >Submit</button>
			</p>
...
<footer id="footer" role="contentinfo">
		<section class="section section-copyright-padding">
			<div class="container">
				<div class="copyright">
					Copyright &copy; 2015 - 2016 - All Rights Reserved with Mohit Saini
					<a href="http://www.cse.iitd.ac.in/~cs1120233/">Contact Us</a>
				</div>
